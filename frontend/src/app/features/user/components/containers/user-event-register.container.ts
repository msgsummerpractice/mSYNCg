...
import { EventForm, EventRegistrationForm } from '../../../../core/models/event.model';
...
export class UserEventRegisterContainer {
  ...
  protected readonly eventFormGroup = this.fb.group<EventRegistrationForm>({
    ...
    photoConsent: this.fb.control<boolean>(false, Validators.requiredTrue),
